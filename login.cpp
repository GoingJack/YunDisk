    ...
    ui(new Ui::Login)
{
    ...
    // 窗口图标
    this->setWindowIcon(QIcon(":/images/logo1.ico"));
    m_mainWin->setWindowIcon(QIcon(":/images/logo1.ico"));
    // 去掉边框
...
#if 1
    // 测试数据
    ui->reg_usr->setText("Jack");
    ui->reg_nickname->setText("Jack");
    ...
    //读取配置文件信息到服务器设置
    QString ip = m_cm.getCfgValue("web_server","ip","conf/cfg.json");
    QString port = m_cm.getCfgValue("web_server","port","conf/cfg.json");
